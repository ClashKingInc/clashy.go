	...
	return []pageSpec{
		{
			...
			Types:      []string{"Client", "ClientConfig", "SearchClansRequest", "PageOptions", "RequestOptions", "HTTPResponse", "HTTPClient", "Limiter"},
			Functions:  []string{"NewClient", "DefaultClientConfig", "NewHTTPClient", "NewLimiter"},
			MethodRecv: []string{"Client", "HTTPClient", "Limiter"},
		},
		{
			Title:      "Clans",
			File:       "clans.md",
		...
		},
		{
			...
			Types:   []string{"Role", "VillageType", "ClanType", "WarRound", "WarState", "WarResult"},
		},
		{
			Title:      "Miscellaneous",
